...
DRUG_FEAT_FILE = os.path.join(feat_DATA_DIR, 'drug_feat.npy')
DRUG2ID_FILE = os.path.join(feat_DATA_DIR, 'drug2id.tsv')
CELL_FEAT_FILE = os.path.join(feat_DATA_DIR, 'cell_feat.npy')
CELL2ID_FILE = os.path.join(feat_DATA_DIR, 'cell2id.tsv')
